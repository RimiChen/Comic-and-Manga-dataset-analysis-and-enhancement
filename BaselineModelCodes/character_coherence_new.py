...
from character_coherence_minibatching import *
from layers_and_utils import *

DATA_PATH = "./manga_data_random/"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-data', default=DATA_PATH +'manga_random_crop.h5')
    ...
    parser.add_argument('-vgg_feats', default=DATA_PATH +'vgg_features.h5')
