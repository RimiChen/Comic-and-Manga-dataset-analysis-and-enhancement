...
class Create_hdf5:
    ...
    def __init__(self, panels_path, ocr_file, ad_path, dims, max_panels, max_boxes, max_words, max_vocab_size, h5path):
        ...
        self.dump_vocabulary(DATA_PATH+'comics_vocab.p')
...
def main():
    ...
    panels_path = DATA_PATH+'raw_panel_images_oringal/' 
    ##### change OCR files
    ocr_file = DATA_PATH+'OCR_ordered_14.csv' 
    ad_path = DATA_PATH+'predadpages_manga.txt' # these pages have ads according to ad filter
    ##### change dataset
    h5path = DATA_PATH+'manga_style_original.h5' # dumping h5 file at this location
